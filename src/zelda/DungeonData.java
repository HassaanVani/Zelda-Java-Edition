...
public class DungeonData {
    ...
    // Door state constants matching DungeonRoom.DoorState ordinals
    ...
    private static DungeonDef buildLevel1() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), null, null, false, false, false, -1),
    ...
    private static DungeonDef buildLevel2() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), "MAGICAL_BOOMERANG", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
    ...
    private static DungeonDef buildLevel4() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), "STEPLADDER", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
    ...
    private static DungeonDef buildLevel5() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), "RECORDER", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
    ...
    private static DungeonDef buildLevel6() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), "MAGICAL_ROD", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
    ...
    private static DungeonDef buildLevel7() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                new String[]{"DarknutBlue", "DarknutBlue", "DarknutBlue"},
                doors(BOSS, NONE, OPEN, NONE), "RED_CANDLE", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
                doors(OPEN, NONE, OPEN, NONE), null, "Aquamentus", false, false, false, -1),
            new DungeonRoomDef(3, 4, 1, 4,
    ...
    private static DungeonDef buildLevel8() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                new String[]{"DarknutBlue", "DarknutBlue", "DarknutBlue"},
                doors(BOSS, NONE, OPEN, NONE), "MAGICAL_KEY", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
                doors(OPEN, NONE, OPEN, NONE), null, "Gleeok", false, false, false, -1),
            new DungeonRoomDef(3, 4, 1, 4,
    ...
    private static DungeonDef buildLevel9() {
        DungeonRoomDef[] rooms = {
            ...
            new DungeonRoomDef(3, 2, 1, 2,
                ...
                doors(BOSS, NONE, OPEN, NONE), "SILVER_ARROW", null, false, false, false, -1),
            new DungeonRoomDef(3, 3, 1, 3,
                new String[0],
